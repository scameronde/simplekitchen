...
const SAMPLE_RECIPES: CreateRecipeInput[] = [
  {
    ...
    instructions:
      'Toast bread. Beat eggs in a bowl. Melt butter in pan over medium heat. Add eggs and scramble until cooked. Serve with toast.',
  },
  {
    title: 'Avocado Toast',
    ...
    instructions:
      'Toast bread until golden. Mash avocados with lemon juice, salt, and pepper. Spread on toast and serve.',
  },
  {
    ...
    instructions:
      'Butter one side of each bread slice. Place cheese between unbuttered sides. Cook in pan over medium heat until golden on both sides and cheese melts.',
  },
  {
